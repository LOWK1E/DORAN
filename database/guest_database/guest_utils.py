...
CATEGORY_FILES = {
    "sobm": {
        ...
        "guest": os.path.join(os.path.dirname(__file__), "sobm_guest_rules.json"),
    },
    "soict": {
        "user": os.path.join(os.path.dirname(__file__), "..","user_database", "soict_rules.json"),
        "guest": os.path.join(os.path.dirname(__file__), "soict_guest_rules.json"),
    },
    "soit": {
        "user": os.path.join(os.path.dirname(__file__),"..", "user_database", "soit_rules.json"),
        "guest": os.path.join(os.path.dirname(__file__), "soit_guest_rules.json"),
    },
    "soed": {
        "user": os.path.join(os.path.dirname(__file__),"..", "user_database", "soed_rules.json"),
        "guest": os.path.join(os.path.dirname(__file__), "soed_guest_rules.json"),
    },
    "faculty_staff": {
        "user": os.path.join(os.path.dirname(__file__),"..", "user_database", "faculty_staff_rules.json"),
        "guest": os.path.join(os.path.dirname(__file__), "faculty_staff_guest_rules.json"),
    },
    "registrar": {
        "user": os.path.join(os.path.dirname(__file__),"..", "user_database", "registrar_rules.json"),
        "guest": os.path.join(os.path.dirname(__file__), "registrar_guest_rules.json"),
    },
    "faculty": {
        "user": os.path.join(os.path.dirname(__file__),"..", "user_database", "faculty_rules.json"),
        "guest": os.path.join(os.path.dirname(__file__), "faculty_guest_rules.json"),
    },
    "staff": {
        "user": os.path.join(os.path.dirname(__file__),"..", "user_database", "staff_rules.json"),
        "guest": os.path.join(os.path.dirname(__file__), "staff_guest_rules.json"),
    },
}
